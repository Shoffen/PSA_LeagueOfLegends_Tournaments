...
from .models import Naudotojai, Product, Receptai, Forumai, Irasai, Kraujo_tyrimai, Recepto_produktai, Naudotojo_receptai, Megstamiausi_receptai, Valgiarasciai, Komentarai, Valgymai, Valgomas_produktas, Valgymo_receptas
